...
####
PROJECT_LIBSSH2_WITH_DISABLED_TEST_APPS="${MY_PROJECT_LIBSSH2_WITH_DISABLED_TEST_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_LIBSSH2_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBSSH2_WITH_DISABLED_TEST_APPS=$PROJECT_LIBSSH2_WITH_DISABLED_TEST_APPS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: libssh2 with disabled test apps: $PROJECT_LIBSSH2_WITH_DISABLED_TEST_APPS"
